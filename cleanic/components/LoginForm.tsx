...
export function LoginForm() {
  ...
  return (
    <section className="w-full max-w-md">
      <div className="relative overflow-hidden rounded-4xl border border-white/70 bg-white/92 p-6 shadow-[0_30px_100px_rgba(16,185,129,0.16)] backdrop-blur-xl sm:p-8">
        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="max-w-sm text-sm leading-6 text-slate-600">
              Akses akunmu dengan tampilan yang lembut, rapi, dan nyaman
              dilihat.
            </p>
          </div>
        </div>
